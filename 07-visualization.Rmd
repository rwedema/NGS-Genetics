...
This chapter describes some methods of visualizing the variants found. They can support the findings or simply make them more interesting to see. For this project, select a visualization type and use your found/filtered variants to create at least one visualization.
