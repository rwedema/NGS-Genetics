...
**Step 1**: In the tool *SnpEff eff: annotate variants*, select the filtered VCF file as input and for *Genome Source* select *Download on demand*. Enter `GRCh38.p14` in the *Snpff Genome Version Name* field. Running the tool (takes between 2-5 minutes) results in two files; one HTML file with 'summary statistics' and one VCF file with updated information for the variants.
